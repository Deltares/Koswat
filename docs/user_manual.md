...
- [Command line tool](#as-a-command-line-tool)
- [Sandbox](#as-a-sandbox)
- [Examples (external)](examples.md)
- [Docker](docker.md)

## Requirements

This guideline assumes you have installed koswat, otherwise please check our [installation page](installation.md)
