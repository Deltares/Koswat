...
class StabilityWallCrestInputProfileCalculation(
    ReinforcementInputProfileCalculationBase,
    ReinforcementInputProfileCalculationProtocol,
):
    ...
    def build(self) -> StabilityWallCrestInputProfile:
        _reinforced_data = self._get_reinforcement_profile(
            StabilityWallCrestInputProfile, self.base_profile.input_data, self.scenario
        )
        assert isinstance(_reinforced_data, StabilityWallCrestInputProfile)
        ...
        _polderside_berm_calculator = BermCalculatorFactory.get_berm_calculator(
            InputProfileEnum.STABILITY_WALL_CREST, _calculated_factors
        )
        (
