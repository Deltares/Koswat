...
class StandardReinforcementProfileBuilder(ReinforcementProfileBuilderBase):
    ...
    def get_input_profile_calculator(
        ...
        if issubclass(reinforcement_type, StabilityWallCrestReinforcementProfile):
            return StabilityWallCrestInputProfileCalculation()
        if issubclass(reinforcement_type, StabilityWallToeReinforcementProfile):
            return StabilityWallToeInputProfileCalculation()
