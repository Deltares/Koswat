...
@dataclass
class ClusterGeoDataFrameOutputFom:
    """
    Dataclass to wrap the output generated by `ClusterCollectionShpFom.generate_geodataframes`.
    """

    base_layer: GeoDataFrame
    initial_state: GeoDataFrame
    new_state: GeoDataFrame
...
class ClusterCollectionShpFom:
    ...
    def generate_geodataframes(self) -> ClusterGeoDataFrameOutputFom:
        ...
        return ClusterGeoDataFrameOutputFom(
            base_layer=_gdf_tuple[0],
            initial_state=_gdf_tuple[1],
            new_state=_gdf_tuple[2],
        )
