...
class StrategyProtocol(Protocol):
    def apply_strategy(strategy_input: StrategyInput) -> list[StrategyLocationReinforcement]:
        """
        ...
        Args:
            strategy_input (StrategyInput): Input data structure containing locations and
            available reinforcements for each of them.
