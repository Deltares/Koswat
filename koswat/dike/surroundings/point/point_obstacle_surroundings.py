...
class PointObstacleSurroundings(PointSurroundings):
    ...
    def _get_min_value(self, value_1: float, value_2: float) -> float:
    ...
    def merge(self, other: PointObstacleSurroundings) -> None:
        self.inside_distance = self._get_min_value(self.inside_distance, other.inside_distance)
        self.outside_distance = self._get_min_value(self.outside_distance, other.outside_distance)
        self.angle_inside = self._get_min_value(self.angle_inside, other.angle_inside)
        self.angle_outside = self._get_min_value(self.angle_outside, other.angle_outside)
    ...
    def closest_obstacle(self) -> float:
        ...
        return self._get_min_value(self.inside_distance, self.outside_distance)
    
    @property
    def obstacle_free_room(self) -> float:
        """
        Available room without obstacles between inside and outside of the dike.
