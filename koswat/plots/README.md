...
The module is divided in sub-modules. Each one trying to represent the upper domain modules to delegate responsibilites. For instance, plottings related to `koswat.dike` will be found at `koswat.plots.dike` module.
