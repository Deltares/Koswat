...
class KoswatGeneralJsonFom(KoswatJsonFomProtocol):
    ...
    # Use soil measure section for now
    ...
    stability_wall_crest_section: StabilityWallCrestReinforcementSectionFom
    ...
    def from_json(cls, koswat_config_fom: KoswatJsonFom) -> "KoswatGeneralJsonFom":
        ...
        return cls(
            analysis_section=AnalysisSectionFom.from_config(
                json_config["analyse"], koswat_config_fom.file_path.parent
            ),
            ...
            stability_wall_toe_section=(
                StabilityWallToeReinforcementSectionFom.from_config(
                    json_config["stabiliteitswandteen"], set_defaults=True
                )
            ),
            stability_wall_crest_section=(
