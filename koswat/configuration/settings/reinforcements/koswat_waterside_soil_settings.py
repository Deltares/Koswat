...
@dataclass
class KoswatWatersideSoilSettings(KoswatConfigProtocol):
    """
    Settings related to Waterside soil reinforcement
    """
    ...
    def set_defaults(
        self, other: "KoswatWatersideSoilSettings"
    ) -> "KoswatWatersideSoilSettings":
        """
        Add the defaults from another KoswatWatersideSoilSettings instance to this instance, if not set.

        Args:
            other (KoswatWatersideSoilSettings): The other instance to get defaults from.

        Raises:
            TypeError: If the other instance has a different type.

        Returns:
            KoswatWatersideSoilSettings: The instance with defaults set.
        """
        if not isinstance(other, KoswatWatersideSoilSettings):
