...
class TestKoswatRunSettingsImporter:
    ...
    def test_when__import_dike_section_input_list_given_no_json_files_then_empty_result_list(
        self, empty_dir: Path
    ):
        # 1. Define test data.
    ...
    def test_when__import_dike_section_input_list_given_missing_folder_then_empty_result_list(
        self,
    ):
        # 1. Define test data.
    ...
    def test_when_import_from_given_valid_json_then_returns_expected_config_instance(
        self,
    ):
        # 1. Define test data.
    ...
    def _compare_settings_as_dict(
        self,
        settings_a: dict[str, float],
        settings_b: dict[str, float],
    ...
    def _get_valid_general_settings_soil_measurement(
        ...
        def settings_comparison(
            ...
            assert (
                reinforcement_settings.soil_settings.soil_surtax_factor
    ...
    def _get_valid_general_settings_piping_wall_measurement(
        ...
        def settings_comparison(
            ...
            self._compare_settings_as_dict(
                ...
                except_keys=[
                    "min_length_piping_wall",
                    "max_length_piping_wall",
                    "transition_cbwall_sheetpile",
                ],
            )
            assert (
                reinforcement_settings.piping_wall_settings.min_length_piping_wall == 5
            )
            assert (
                reinforcement_settings.piping_wall_settings.max_length_piping_wall == 30
            )
            assert (
                reinforcement_settings.piping_wall_settings.transition_cbwall_sheetpile
                == 95
            )
    ...
    def _get_valid_general_settings_cofferdam_measurement(
        ...
        def settings_comparison(
            ...
            assert (
                reinforcement_settings.cofferdam_settings.soil_surtax_factor
                == SurtaxFactorEnum.MOEILIJK
            )
    ...
    def _get_valid_general_settings_surroundings(
        ...
        assert (
            general_settings.surroundings_section.allow_waterside_reinforcement == True
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                "general_settings_stability_wall_toe_measurement",
                id="stability_wall_toe_measurement",
            ),
            pytest.param(
                "general_settings_stability_wall_crest_measurement",
                id="stability_wall_crest_measurement",
            ),
            pytest.param(
                "general_settings_cofferdam_measurement", id="cofferdam_measurement"
            ),
            pytest.param("general_settings_surroundings", id="surroundings"),
        ],
    )
    def test_when__get_dike_section_input_given_custom_section_settings_then_general_settings_are_overriden(
        ...
        ) = KoswatRunSettingsImporter()._get_dike_section_input(
