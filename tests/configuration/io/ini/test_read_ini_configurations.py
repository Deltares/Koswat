...
class TestReadIniConfigurations:
    ...
    def test_koswat_ini_read_general_ini(self):
        ...
        assert (
            _ini_fom.grondmaatregel_section.purchase_landraise_factor
            == RaiseFactorEnum.NORMAAL
        )
        ...
        assert (
            _ini_fom.kwelscherm_section.purchase_landraise_factor
            == RaiseFactorEnum.NORMAAL
        )
        ...
        assert (
            _ini_fom.stabiliteitswand_section.purchase_landraise_factor
            == RaiseFactorEnum.MOEILIJK
        )
        ...
        assert (
            _ini_fom.kistdam_section.purchase_landraise_factor
            == RaiseFactorEnum.NORMAAL
        )
