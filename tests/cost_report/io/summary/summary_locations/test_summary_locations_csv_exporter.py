...
class TestSummaryLocationsCsvExporter:
    ...
    def test_summary_locations_csv_exporter_export(
        ...
        _expected_text = """Section;X coord;Y coord;Kistdam;Kwelscherm;Grondmaatregel profiel;Stabiliteitswand;Initial selection;Ordered selection;Optimized selection
