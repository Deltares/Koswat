...
class TestVPSInputProfileCalculation:
    ...
    def test_calculate_new_binnen_talud(self):
        ...
        # 2. Run test
        _new_binnen_talud = VPSInputProfileCalculation()._calculate_new_binnen_talud(
    ...
    def test_calculate_new_binnen_berm_hoogte_positive_binnen_berm_breedte(self):
        ...
        _new_binnen_berm_hoogte = (
            VPSInputProfileCalculation()._calculate_new_binnen_berm_hoogte(
    ...
    def test_calculate_new_binnen_berm_breedte(self):
        ...
        _new_binnen_berm_breedte = (
            VPSInputProfileCalculation()._calculate_soil_binnen_berm_breedte(
    ...
    def test_calculate_new_kruin_hoogte(self):
        ...
        # 2. Run test
        _new_kruin_hoogte = VPSInputProfileCalculation()._calculate_new_kruin_hoogte(
            _old_data, _scenario
        )
