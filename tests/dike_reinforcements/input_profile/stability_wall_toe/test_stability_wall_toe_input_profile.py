...
class TestStabilityWallToeInputProfile:
    def test_initialize(self):
        _input = StabilityWallToeInputProfile()
        assert isinstance(_input, StabilityWallToeInputProfile)
    ...
    def test_ground_price(self):
        ...
        _builtup = 100
        _unbuilt = 10
        _profile = StabilityWallToeInputProfile()
